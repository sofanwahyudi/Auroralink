...
@section('title')
    Team | Tickets Prioritas
@endsection
@section('content_header')
    <h1>
        <span class="fa fa-filter"></span> Tickets Prioritas
        <a href="{{route('prioritas.create')}}" class="btn-sm btn-primary modal-show"><span class="fa fa-plus"></span> Tambah Data</a>
    </h1>
    <ol class="breadcrumb">
    <li>
    ...
    <a href="{{route('export_part_csv')}}" class="btn-sm btn-success" style="color:white"><span class="fa fa-file" style="color:white"></span> Export Csv</a> --}}
      ...
      <li>Team</li>
      <li class="active">Ticket Prioritas</li>
    </ol>
@endsection
@section('content')
