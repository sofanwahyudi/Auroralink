...
@section('title')
    Team | Tickets Kategori
@endsection
@section('content_header')
    <h1>
        <span class="fa fa-filter"></span> Tickets Kategori
        <a href="{{route('cats.create')}}" class="btn-sm btn-primary modal-show"><span class="fa fa-plus"></span> Tambah Data</a>
    </h1>
    <ol class="breadcrumb">
    <li>
    ...
    <a href="{{route('export_part_csv')}}" class="btn-sm btn-success" style="color:white"><span class="fa fa-file" style="color:white"></span> Export Csv</a> --}}
      ...
      <li>Tickets</li>
      <li class="active">Tickets Kategori</li>
    </ol>
@endsection
@section('content')
