...
@section('title')
    Pelanggan | Auroralink
@endsection
@section('content_header')
    <h1>
        <span class="fa fa-users"></span> Pelanggan
        <a href="{{route('pelanggan.create')}}" class="btn-sm btn-primary modal-show" title="Tambah Data"><span class="fa fa-plus"></span> Tambah Data</a>
        <!-- <a href="#" data-url="" class="btn-sm btn-danger delete-all"><span class="fa fa-trash"></span> Hapus Data Terpilih</a>
    <button style="margin: 5px;" class="btn btn-danger btn-xs delete-all" data-url="">Delete All</button>  -->
    </h1>
    <ol class="breadcrumb">
    <li>
            <a href="{{route('exportExcelPelanggan')}}" class="btn-sm btn-success" style="color:white"><span class="fa fa-file-excel-o" style="color:white"></span> Export Excel</a>
            <a href="{{route('exportCsvPelanggan')}}" class="btn-sm btn-success" style="color:white"><span class="fa fa-file" style="color:white"></span> Export Csv</a>
    </li>
