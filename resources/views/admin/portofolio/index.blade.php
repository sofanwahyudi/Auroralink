...
@section('title')
    Portofolio | Auroralink
@endsection
@section('content_header')
    <h1>
        <span class="fa fa-image"></span> Portofolio
        <a href="{{route('portofolio.create')}}" class="btn-sm btn-primary modal-show"><span class="fa fa-plus"></span> Tambah Data</a>
          ...
          @if(Session::has('success'))
            ...
            <table id="datatable" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Youtube ID</th>
