...
@section('title')
Create Galery | Auroralink
@stop
@section('content_header')
<h1>
    <span class="fa fa-edit"></span> Create galery
</h1>
<ol class="breadcrumb">
	        ...
	        <div class="row">
	          <div class="col-md-9">
	            ...
	            <div class="box-body">
                    ...
                    <label for="name" class="control-label">Demo Url</label>
                        <div class="input-group">
                    ...
                    <div class="form-group col-md-6 required ">
                    <label for="name" class="control-label">Kategori Galery</label>
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-filter"></i></div>
