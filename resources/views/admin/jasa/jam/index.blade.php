...
@section('title')
    Jam Layanan | Auroralink
@endsection
@section('content_header')
    <h1>
        <span class="fa fa-hourglass-2"></span> Jam Layanan
        <a href="{{route('jam.create')}}" class="btn-sm btn-primary modal-show"><span class="fa fa-plus"></span> Tambah Data</a>
    ...
    <a href="{{route('export_part_csv')}}" class="btn-sm btn-success" style="color:white"><span class="fa fa-file" style="color:white"></span> Export Csv</a> --}}
      ...
      <li>Jasa</li>
      <li class="active">Jam Layanan</li>
    </ol>
@endsection
@section('content')
          ...
          @if(Session::has('success'))
            ...
            <table id="datatable" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Jam Buka</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Jam Tutup</th>
...
$(document).ready(function(){
    ...
    columns: [
        { data: 'nama', name: 'nama' },
        { data: 'jam_start', name: 'jam_start' },
        { data: 'jam_end', name: 'jam_end' },
