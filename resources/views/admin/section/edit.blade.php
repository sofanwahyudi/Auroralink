...
@section('title')
Edit Section | Auroralink
@stop
@section('content_header')
<h1>
    <span class="fa fa-edit"></span> Edit Section
</h1>
<a href="{{route('sections')}}"><i class="fa fa-arrow-left"></i> Back To List Section</a>
	      ...
	      <div class="container-fluid">
	        <div class="row">
	          <div class="col-md-9">
                ...
                {!! Form::model($model, ['action' => ['SectionController@update', $model->id], 'method' => 'PUT', 'files' => true]) !!}
	            <div class="card">
