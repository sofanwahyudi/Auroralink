...
<a data-toggle="collapse" href="#multiCollapseExample1{{ $reply->id }}" role="button" aria-expanded="false" aria-controls="multiCollapseExample1" style="margin-left:10px;"><span class="fa fa-reply"></span>  Reply</a>
<div class="row">
  <div class="col">
    <div class="collapse multi-collapse" id="multiCollapseExample1{{ $reply->id }}">
      <div class="author-info">
        ...
        {!! Form::text('body',$reply->users->name, ['class' => 'form-control','placeholder' => 'Enter Your Comment Here....']) !!}
